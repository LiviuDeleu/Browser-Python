...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        title = QLabel("Lucrare de laborator")
        font = title.font()
...
class MainWindow(QMainWindow):
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Liviu's Browser" % title)

    def navigate_mozarella(self):
        self.browser.setUrl(QUrl("https://github.com/LiviuDeleu"))
